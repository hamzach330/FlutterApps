...
class GetLoggedInUser {
  ...
  factory GetLoggedInUser.fromJson(GatewayRpcResponse json) =>
          _$GetLoggedInUserFromJson(json.result!);

  Map<String, dynamic> toJson() => _$GetLoggedInUserToJson(this);

  /// ## get_logged_in_user
  static GatewayRequestParamBuilder<GetLoggedInUser> param() {
    final param = {
    "method" : 'getLoggedInUser',
    "params" : []
  };
    return GatewayRequestParamBuilder<GetLoggedInUser>(
      param,
      (json) => GetLoggedInUser.fromJson(GatewayRpcResponse.fromJson(json)));
  }
}