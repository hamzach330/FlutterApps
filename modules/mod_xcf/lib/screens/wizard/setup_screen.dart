...
class XCFSetupView extends StatefulWidget {
  static const route = '/xcf/setup';
  static Widget buildRoute(dynamic evo) => const XCFSetupView();
  static open (BuildContext context) => UICScaffold.of(context).contentNavigator?.pushNamed(route);

  const XCFSetupView({super.key});

  @override
  State<XCFSetupView> createState() => _XCFSetupViewState();
}

class _XCFSetupViewState extends State<XCFSetupView> {
  ...
  Widget build(BuildContext context) {
    ...
    return LayoutBuilder(
      builder: (context, constraints) {
        ...
        return UICPage(
          //title: "Inbetriebnahme".i18n,
          //elevation: 0,
          //menu: true,
          slivers: [
            //Todo FIXME : Empty Header
            UICPinnedHeader(
              leading: UICTitle("Inbetriebnahme".i18n),
            ),
            SliverToBoxAdapter(
              child: Center(
                child: SizedBox(
