...
class CCElevenSliderAlert extends UICAlert<(double?, double?)> {
...
class _CCElevenSliderAlert extends StatefulWidget {
  final double? position;
  final double? slat;
  
  const _CCElevenSliderAlert({
    this.position,
    this.slat
  });
  
  @override
  _CCElevenSliderAlertState createState() => _CCElevenSliderAlertState();
}

class _CCElevenSliderAlertState extends State<_CCElevenSliderAlert> {
  double position = 0;
  double slat = 0;
